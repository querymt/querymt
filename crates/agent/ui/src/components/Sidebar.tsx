  ...
  return (
    <Dialog.Root open={open} onOpenChange={onOpenChange}>
      <Dialog.Portal>
        ...
        <Dialog.Content
          className="
            fixed top-0 left-0 h-full w-80 bg-cyber-surface border-r border-cyber-cyan/30 z-50
        ...
        >
          ...
          <div className="flex items-center justify-between p-6 border-b border-cyber-border">
            <Dialog.Title className="text-xl font-bold neon-text-cyan">Session Control</Dialog.Title>
            <Dialog.Close className="text-gray-400 hover:text-cyber-cyan transition-colors">
              <X className="w-6 h-6" />
            </Dialog.Close>
          </div>
