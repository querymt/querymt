            ...
            <Command.Group className="mb-1">
              {themes.map((theme) => (
                <Command.Item
                  key={theme.id}
                  value={theme.label}
                  keywords={[theme.id, theme.description]}
                ...
                >
                  <div className="flex-1 min-w-0">
                    <div className="text-sm text-gray-200 truncate">{theme.label}</div>
                    <div className="text-xs text-gray-500 truncate">{theme.description}</div>
                  </div>
                  <div className="flex items-center gap-2 flex-shrink-0">
                    <span className="text-[10px] text-gray-600 font-mono">{theme.id}</span>
