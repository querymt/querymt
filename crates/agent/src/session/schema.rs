...
pub fn init_schema(conn: &mut Connection) -> Result<(), rusqlite::Error> {
    conn.execute_batch(
        ...
        CREATE TABLE IF NOT EXISTS delegations (
            ...
            input_packet_id TEXT,    -- Optional work packet used as delegation input
            status TEXT NOT NULL,
        ...
        -- ========================================================================
        -- WORK PACKETS — Durable context artifacts for planning, handoff, and
        ...
        -- FTS5 index for full-text search over packet title, summary, and body.
        ...
        -- FTS sync triggers for work_packets
        ...
        -- Active packet association: which packet is "active" for a given session.
