                            ...
                            if task_completion_guard_continuations == 0 {
                                ...
                                state = ExecutionState::BeforeLlmCall {
                                    context: Arc::new(completed_context.inject_message(
                                        "The current finite task remains active. Continue the work, call complete_task with concrete evidence, pause or cancel it with a real reason, or ask the user for required information. An ordinary response stop does not complete the task.".to_string(),
                                    )),
                                };
                                continue;
                            }
