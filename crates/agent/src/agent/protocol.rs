...
// SendAgent for QueryMTAgent has been removed - QueryMTAgent is now pub(crate)
// and only used as a builder scratch space. The public API uses AgentHandle
// which implements SendAgent in agent/handle.rs.
